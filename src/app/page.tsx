      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex gap-4 justify-center mb-16">
            ...
            <a
              href="#features"
              className="px-8 py-4 bg-card dark:bg-gray-800 text-indigo-900 dark:text-indigo-300 font-semibold rounded-xl border-2 border-indigo-100 dark:border-indigo-900 hover:border-indigo-200 dark:hover:border-indigo-700 transition-all"
            >
              Learn More
            </a>
          </div>
